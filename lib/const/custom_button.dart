...
VoidCallback ?onTap,
  ...
  return InkWell(
    ...
    child: Container(
      ...
      color: primaryBlue,),
      child: Text("$title", style: myStyleMontserrat(14.sp, secondaryWhite, FontWeight.w600),),
    ),
  );
}
...
class CustomHomePageContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        height: 115.h,
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(8.r), color: primaryWhite,
        ...
        child: Column(
          ...
          children: [
            ...
            Text("$title", style: myStyleMontserrat(12.sp, homeItemColor, FontWeight.w700),),
          ],
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        width: 146.w,
        height: 35.h,
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(8.r), color: primaryDeepBlue),
        child: Text("$title", style: myStyleMontserrat(12.sp, primaryWhite, FontWeight.w600),),
      ),
    );
  }
}
          ...
          children: [
            Row(
              children: [
                Image.asset("$image"),
                SizedBox(width: 8.w,),
                Text("$title", style: myStyleMontserrat(13, secondaryWhite, FontWeight.w500),),
              ],
            ),
            Text("$amount", style: myStyleMontserrat(20, secondaryWhite, FontWeight.w500),),
          ],
        ),
      ),
    );
